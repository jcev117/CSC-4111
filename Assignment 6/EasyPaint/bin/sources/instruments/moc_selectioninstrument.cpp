...
#include "../../../sources/instruments/selectioninstrument.h"
...
void SelectionInstrument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SelectionInstrument::sendEnableCopyCutActions)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SelectionInstrument::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SelectionInstrument::sendEnableSelectionInstrument)) {
                *result = 1;
                return;
            }
        }
...
void *SelectionInstrument::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectionInstrument.stringdata0))
        return static_cast<void*>(const_cast< SelectionInstrument*>(this));
