...
void ImageArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendPrimaryColorView)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ImageArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendSecondaryColorView)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendNewImageSize)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendCursorPos)) {
                *result = 3;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendColor)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (ImageArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendRestorePreviousInstrument)) {
                *result = 5;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendSetInstrument)) {
                *result = 6;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendEnableCopyCutActions)) {
                *result = 7;
                return;
            }
        }
        {
            typedef void (ImageArea::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageArea::sendEnableSelectionInstrument)) {
                *result = 8;
                return;
            }
        }
...
void *ImageArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageArea.stringdata0))
        return static_cast<void*>(const_cast< ImageArea*>(this));
